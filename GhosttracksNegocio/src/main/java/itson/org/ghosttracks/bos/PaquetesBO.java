...
import itson.org.ghosttracks.persistencia.PaquetesDAO; 
...
public class PaquetesBO implements IPaquetesBO {
    ...
    public PaquetesBO() {
        this.paquetesDAO = new PaquetesDAO(); 
    ...
    public Paquete generarAsignarGuia(String idPaquete) throws NegocioException {
        try {
            ...
            String idPedidoRef = paqueteDB.getPedido().getIdPedido();
    ...
    @Override
    public Paquete consultarPaquetePorId(String idPaquete) throws NegocioException {
        try {
